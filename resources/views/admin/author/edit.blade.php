        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("content.edit_author")}}</h4>
                </div>
                <div class="card-body ">
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form method="post" action="{{route("admin-author.update",$author->id)}}"  id="js-form" enctype="multipart/form-data">
                        @method("PUT")
                        @csrf
                        <div class="form-group bmd-form-group">
                            <label for="title" class="bmd-label-floating">{{__("validation.attributes.name")}}</label>
