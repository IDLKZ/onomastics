...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            <form method="post" action="{{route('admin-user.update',$user->id)}}" id="js-form" enctype="multipart/form-data">
                @method("PUT")
                @csrf
                <div class="card ">
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title">{{__("content.edit_user")}}</h4>
                    </div>
                    <div class="card-body ">
                    ...
                    <div class="card-body ">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleTitle" value="{{$user->name}}">
                        </div>
                    </div>
                    <div class="card-body ">
                        <div class="form-group bmd-form-group">
                            <label for="exampleTitle" class="bmd-label-floating">{{__("validation.attributes.email")}}</label>
                            <input type="email" name="email" class="form-control" id="exampleTitle" value="{{$user->email}}">
                        </div>
                    </div>
                    <div class="card-body ">
                        <div class="form-group bmd-form-group">
