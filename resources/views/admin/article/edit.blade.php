        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("content.edit_news")}}</h4>
                </div>
                <div class="card-body ">
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form method="post" action="{{route("admin-article.update",$article->id)}}"  id="js-form" enctype="multipart/form-data">
                        @method("PUT")
                        @csrf
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="subtitle" value="{{$article->subtitle}}">
                        </div>
                        ...
                        <div class="form-group bmd-form-group">
                            ...
                            <select class="links w-100" name="links[]" multiple>
                                @if($article->links)
                        ...
                        <div class="card-footer ">
                            <a href="{{route('admin-article.index')}}" class="btn btn-fill btn-default">{{__("content.back")}}</a>
