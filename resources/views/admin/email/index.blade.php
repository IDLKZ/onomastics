        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("validation.attributes.email")}}</h4>
                    <a href="{{route('admin-email.create')}}" class="btn btn-primary create">{{__("content.create")}}<div class="ripple-container"></div></a>
                </div>
                <div class="card-body">
                                ...
                                @foreach($emails as $email)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <form class="d-inline" action="{{route('admin-email.destroy', $email->id)}}" method="post">
                                                @method('delete')
                                                @csrf
