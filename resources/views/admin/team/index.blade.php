        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("content.teams")}}</h4>
                    <a href="{{route('admin-team.create')}}" class="btn btn-primary create">{{__("content.create")}}<div class="ripple-container"></div></a>
                </div>
                <div class="card-body">
                    @if($teams->isNotEmpty())
                            ...
                            <table class="table">
                                ...
                                @foreach($teams as $team)
                                    <tr>
                                        ...
                                        <td><img src="{{$team->img}}" style="max-height: 130px; max-width: 130px;"></td>
                                        <td>{{$team->name}}</td>
                                        <td>{{$team->position}}</td>
