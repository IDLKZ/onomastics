        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("content.update_dictionary")}}</h4>
                </div>
                <div class="card-body ">
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form method="post" action="{{route("admin-dictionary.update",$dictionary->id)}}"  id="js-form" enctype="multipart/form-data">
                        @method("PUT")
                        @csrf
                        <div class="form-group bmd-form-group">
                            <label for="title" class="bmd-label-floating">{{__("validation.attributes.word")}}</label>
                            <input type="text" class="form-control" id="title" name="word" value="{{$dictionary->word}}">
                        </div>
