        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">{{__("content.galleries")}}</h4>
                    <a href="{{route('admin-gallery.create')}}" class="btn btn-primary create">{{__("content.create")}}<div class="ripple-container"></div></a>
                </div>
                <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                @foreach($galleries as $gallery)
                                    <tr>
                                        ...
                                        <td><img src="{{$gallery->img}}" style="max-height: 130px; max-width: 130px;"></td>
                                        <td>{{$gallery->title}}</td>
