            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form method="post" action="{{route("admin-advantage.update",$advantage->id)}}"  id="js-form" enctype="multipart/form-data">
                        @method("PUT")
                        @csrf
                            ...
                            <select class="form-control w-100" id="category" name="language_id">
                                @if($languages->isNotEmpty())
                                    @foreach($languages as $language)
                                        @if($advantage->language_id == $language->id)
                        ...
                        <div class="card-footer ">
                            <a href="{{route('admin-advantage.index')}}" class="btn btn-fill btn-default">{{__("content.back")}}</a>
